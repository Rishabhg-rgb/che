  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <div className=' text-white text-3xl font-bold tracking-widest  '>Cheeta's</div>
        </NavLink>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/settings"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('addClient') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
